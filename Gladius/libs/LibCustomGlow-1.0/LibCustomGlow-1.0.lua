...
local textureList = {
	["empty"] = [[Interface\AddOns\Gladius\Libs\LibCustomGlow-1.0\AM_29]],
	["white"] = [[Interface\BUTTONS\WHITE8X8]],
	["shine"] = [[Interface\AddOns\Gladius\Libs\LibCustomGlow-1.0\Artifacts]]
}
...
local function configureButtonGlow(f, alpha)
	...
	f.spark:SetAlpha(0)
	f.spark:SetTexture([[Interface\AddOns\Gladius\Libs\LibCustomGlow-1.0\IconAlert]])
	...
	f.innerGlow:SetTexture([[Interface\AddOns\Gladius\Libs\LibCustomGlow-1.0\IconAlert]])
	...
	f.innerGlowOver:SetTexture([[Interface\AddOns\Gladius\Libs\LibCustomGlow-1.0\IconAlert]])
	...
	f.outerGlow:SetTexture([[Interface\AddOns\Gladius\Libs\LibCustomGlow-1.0\IconAlert]])
	...
	f.outerGlowOver:SetTexture([[Interface\AddOns\Gladius\Libs\LibCustomGlow-1.0\IconAlert]])
	...
	f.ants:SetAlpha(0)
	f.ants:SetTexture([[Interface\AddOns\Gladius\Libs\LibCustomGlow-1.0\IconAlertAnts]])
